...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
       ...
       # as classifier label
       full_path_name = f"{images_dir}/{key}"
       model_label = classifier(full_path_name, model)
       ...
       if truth in model_label:
           results_dic[key].extend([model_label, 1]) #yes match
       ...
       # the extend function 
           ...
           results_dic[key].extend([model_label, 0]) # no match