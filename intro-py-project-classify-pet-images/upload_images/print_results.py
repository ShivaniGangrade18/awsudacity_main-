...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print(f"{'N Not-Dog Images':<20}: {results_stats_dic['n_notdogs_img']:>3}")
    """
    print("\n\n*** Results Summary for CNN Model Architecture", model.upper(), 
          "***")
    ...
    #          results_stats_dic
    #
    print("{:20}: {:30d}".format('N Not-Dog Images', results_stats_dic['n_notdogs_img']))
"""
    ...
    for key in results_stats_dic:
        ...
        if key.startswith('pct'):
                print(f"{key:<20}: {results_stats_dic[key]:>6.2f}%")
        ...
        for key in results_dic:
            ...
            (results_dic[key][3] == 0 and results_dic[key][4] == 1)):
                        #print("Real: {:>26} Classifier: {:>30}".format(results_dic[key][0], 
                                                                #results_dic[key][1]))
                        print(f"Real: {results_dic[key][0]:>25}   Classifier: {results_dic[key][1]:>30}")
